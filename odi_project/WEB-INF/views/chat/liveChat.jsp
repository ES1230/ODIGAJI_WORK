...
<body>
    ...
    <div class="main-chat-area">
      <a href="">
        <div class="chat-room">
          ...
          <div class="number-of-participants"> 50명 참여중 </div>
          <div class="chat-room-name">부산 여행 맛집/여행 정보 궁금한 사람 드루와</div>
          <div class="new" style="display: block;">NEW</div>
        </div>
      </a>
      ...
      <div class="chat-room"></div>
      <div class="chat-room"></div>
      <button class="create-chat-room" id="create-chat-room" onclick="createChatRoom()"> 채팅방 생성 </button>
    </div>
  </div>
  ...
  <div class="inner">
    <div class="create-chat-box" style="display:none;" id="create-chat-box">
      ...
      <button class="create-chat" name="" id="create-chat">생성</button>
